...
-- Volcando estructura de base de datos para dbburger
CREATE DATABASE IF NOT EXISTS `dbburger` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dbburger`;
...
INSERT INTO `producto` (`id`, `name`, `price`, `stock`) VALUES
	(1, 'Burger Simple', 27.00, 35),
	(2, 'Burger Doble', 35.00, 40),
	(3, 'Burger Especial', 50.00, 25);
